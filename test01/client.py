...
def handle_election_message(tcp_socket, data):
    ...
    if is_leader:
        ...
        send_message_to_server(tcp_socket, "election", mid=str(sender_id), isLeader="true")
        ...
        is_participant = False
        election_in_progress = False
        print(f"I am the new leader (ID: {my_id})")
...
def receive_messages(tcp_socket):
    global my_id, current_chatroom, is_participant, leader_id, election_in_progress
...
def main():
    global my_id, tcp_socket, current_chatroom, election_in_progress
        ...
        while True:
            ...
            if choice == '1':
                ...
                if not election_in_progress:
                    ...
                    print("An election is already in progress.")
            elif choice == '5':
